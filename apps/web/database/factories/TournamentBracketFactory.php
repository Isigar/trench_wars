...
| PHPStan L8 cannot validate `@extends Factory<App\Models\TournamentBracket>`
| against a non-existent class, and CLAUDE.md §3 forbids baseline regeneration.
|
| @phpstan-ignore-next-line missingType.generics
*/
final class TournamentBracketFactory extends Factory
{
    /** @phpstan-ignore-next-line property.defaultValue */
    protected $model = 'App\\Models\\TournamentBracket';
