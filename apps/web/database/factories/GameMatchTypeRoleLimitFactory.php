 ...
 * PHPStan L8 cannot validate `@extends Factory<App\Models\GameMatchTypeRoleLimit>`
...
class GameMatchTypeRoleLimitFactory extends Factory
{
    ...
    protected $model = 'App\\Models\\GameMatchTypeRoleLimit';
    ...
    {
        throw new RuntimeException('GameMatchTypeRoleLimitFactory definition not yet implemented (Wave 0 stub — replaced by plan 03-03).');
    }
}
